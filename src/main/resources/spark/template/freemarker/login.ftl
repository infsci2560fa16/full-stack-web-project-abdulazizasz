        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <form id="signupform" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="repeat-password" class="col-md-3 control-label">Re-Password</label>
                        <div class="col-md-9">
                            <input type="password" class="form-control" name="repasswd" id="repeat-password" placeholder="Repeat Password">
                        </div>
                    </div>
